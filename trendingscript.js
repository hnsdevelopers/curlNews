...
const trendingTopics = ['cricket world cup', 'football', 'basketball', 'Indian Government', 'Arvind Kejriwal', 'Narendra Modi', 'India vs Australia', 'World Cup 2023', 'IPL 2023', 'FIFA World Cup', 'Punjab Election'];

let topic = trendingTopics[Math.floor(Math.random() * trendingTopics.length)];
...
function renderArticles(articles) {
    ...
    xhr.open('GET', `https://newsdata.io/api/1/latest?apikey=pub_60532db82a99eb1d6b1e6dd5202381a2bd965&q=${encodeURIComponent(topic)}&size=10`, true);
    xhr.onload = function() {
        if (xhr.status === 200) {
